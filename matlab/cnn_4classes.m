%% Convolutional Neural Network - Four Classes Classification Problem
...
% pre-trained Alexnet classify images in four classes:
% - anger
% - happiness. 
% - disgust
% - fear
...
img_data = imageDatastore('data/img_4classes', ...
